# Lesson Generation Prompt (paste into NotebookLM or AI Studio)

Replace the three `{{...}}` placeholders with values from `course.json` for the specific lesson.
...
**Quality checklist before you return JSON:**
- [ ] At least 3 quiz questions, all 4-choice multiple choice
- [ ] At least 1 verbatim script block from the source if the lesson involves a script
- [ ] No invented statistics
- [ ] Tyler's voice consistent throughout
- [ ] `duration_min` is a realistic read-time at 200 words/min

Return the JSON only. No preamble. No explanation.
